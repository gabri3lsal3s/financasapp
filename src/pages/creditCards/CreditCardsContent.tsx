...
import { APP_START_DATE, APP_START_MONTH, formatCurrency, formatDate, formatMonth, formatMoneyInput, getCurrentMonthString, parseMoneyInput, roundToDecimals } from '@/utils/format'
  ...
  return (
    <div className="animate-page-enter min-h-[calc(100vh-12rem)] flex flex-col" {...swipeHandlers}>
      <PageHeader
        ...
        subtitle={`${PAGE_HEADERS.creditCards.description} · ${formatMonth(currentMonth)}`}
        action={
          <PageHeaderActions>
