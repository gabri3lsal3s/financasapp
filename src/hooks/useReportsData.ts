...
/**
 * useReportsData — lógica de dados da página Relatórios (extraída do
 * orquestrador). Centraliza períodos disponíveis, carteira do mês, cores,
 * agregados anuais/mensais, modo customizado e os seletores "ativos".
 */
export function useReportsData() {
  ...
  return {
    ...
    toggleDailyConsolidatedSeries,
    toggleMonthCompositionSeries,
    compositionPieType,
...
export type UseReportsDataReturn = ReturnType<typeof useReportsData>
