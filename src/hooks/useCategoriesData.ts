...
import { detectSuggestionRuleFromName } from '@/utils/categorySuggestions'
import type { Category, IncomeCategory } from '@/types'

/**
 * useCategoriesData — lógica de dados e estado da página Categorias (extraída
 * do orquestrador). CRUD de categorias, sugestões de orçamento, limites,
 * expectativas, KPIs consolidados e grids por aba.
 */
...
export type UseCategoriesDataReturn = ReturnType<typeof useCategoriesData>
