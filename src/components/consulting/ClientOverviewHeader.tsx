...
export default function ClientOverviewHeader({
  ...
  return (
    <div className="space-y-4">
      ...
      {isTempClient && (
        <div className="bg-warning/10 border border-warning/20 text-warning p-4 rounded-xl flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs text-left animate-page-enter">
