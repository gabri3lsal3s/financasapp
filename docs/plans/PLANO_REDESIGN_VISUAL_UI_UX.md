...
| R7 | ⏳ Pendente | — |
| **R7+** | ⏳ Pendente | Varredura de harmonia completa (fase criada em 12/08/2026 após auditoria de cobertura: `formatCurrency` direto em ~60 arquivos, 126 labels inline, cards de auth sem glass) — regras e critérios na tabela de roteiro acima |
